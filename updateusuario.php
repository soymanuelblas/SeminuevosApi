...
$sql = "UPDATE usuario SET nombre='$nombre', usr='$usuario', pwd='$encriptado', permisos='$permisos', tipostatus_id='$status', 
sitio_id='$sitio', rol_id = '$rol' WHERE id = '$id' " ;
