...
if(empty($rowPago)){
    ...
    $insertNewPago = "INSERT INTO `pago_crm` (`id`, `payment_id`, `typepago`, `numOrder`, `precio`, `fecha`, `idstatus`) VALUES (NULL, '$payment', '$payment_type', '$order_id', $precio, '$fecha', '13800');";
    ...
    if($insertNewPago){
        ...
        if($insertRazonSocial){
            ...
            $insertAccesoPagos = "INSERT INTO `accesos_pagosCRM` (`id`, `crm_id`, `razon_id`, `item_id`, `estadoPago`,`fechaterminoContrato`) VALUES (NULL, $idPCRM, $idRS, $idITEM, '13803','$mesmas');";
            ...
            if($insertAccesoPagos){
                ...
                if($insertSitio){
                    ...
                    if($insertUser){
                        ...
                        $sql_cliente=" INSERT INTO `clientes` (`id`, `id_interno`, `rfc`, `nombre`, `domicilio`, `colonia`, `telefono1`, `telefono2`, `email`, `ciudad`, `estado`, `cp`, `usuario_id`, `tipostatus_id`, `razonsocial_id`, `tipocliente_id`, `password`) values (NULL,'1','SINRFC','$name','X','X','01234567891','01234567891','x@gmail.com','X','X','X','$usuario','851','$idRS','5300','X')";
                        ...
                        if($insertCliente){
                            ...
                            /*
                            $dir = 'Principales';
                            mkdir("images/".$idS, 0777);
                            mkdir("images/".$idS."/".$dir, 0777);
                            */
    ...
    header("Location: https://seminuevos.tubisne.mx/login.php");
}
