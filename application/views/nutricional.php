    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h3>PLAN DE ASESORIA NUTRICIONAL</h3>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <div class="section-title">
                    <br><br><br>
                    <strong><h1 class="heading bold">PLAN DE ASESORIA NUTRICIONAL</h1></strong>
                    <hr>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="plan plan-one wow bounceIn" data-wow-delay="0.3s">
                    <div class="plan_title">
                        ...
                        <h3>PLAN 1</h3>
                        <!--<h2>$700 <span> / 1 mes</span></h2>-->
                        <h2>$800 <span> / 1 mes</span></h2>
                    </div>
                    <ul>
                        <li><i class="fas fa-x-ray"></i> Composición Corporal.</li>
                        <li><i class="fas fa-weight"></i> Control de peso.</li>
                        <li><i class="fas fa-tasks"></i> Evaluación y seguimiento.</li>
                        <li><i class="fas fa-heart"></i> Mejorar tu salud.</li>
                        <li><i class="fas fa-mobile-alt"></i> Menú por aplicación.</li>
                        <li><i class="fas fa-qrcode"></i> 1 consulta online/presencial</li>
                    </ul>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="plan plan-one wow bounceIn" data-wow-delay="0.3s">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-heart"></i> Mejorar tu salud.</li>
                        <li><i class="fas fa-mobile-alt"></i> Menú por aplicación.</li>
                        <li><i class="fas fa-qrcode"></i> 2 consultas online/presencial</li>
                    </ul>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="plan plan-one wow bounceIn" data-wow-delay="0.3s">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-heart"></i> Mejorar tu salud.</li>
                        <li><i class="fas fa-mobile-alt"></i> Menú por aplicación.</li>
                        <li><i class="fas fa-qrcode"></i> 3 consultas online/presencial</li>
                    </ul>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--<input type="hidden" class="form-control" name="plan" id="plan" value="PLAN DE ASESORIA NUTRICIONAL PLAN 1 $600 / 1 MES" required>-->
                    <input type="hidden" class="form-control" name="plan" id="plan" value="PLAN DE ASESORIA NUTRICIONAL PLAN 1 $800 / 1 MES" required>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--<input type="hidden" class="form-control" name="plan2" id="plan2" value="PLAN DE ASESORIA NUTRICIONAL PLAN 2 $1,100 / 2 MESES" required>-->
                    <input type="hidden" class="form-control" name="plan2" id="plan2" value="PLAN DE ASESORIA NUTRICIONAL PLAN 2 $1,400 / 2 MESES" required>
                    <p style="font-family: Copperplate">Sus datos personales, serán utilizados para ajustar su peso y estura a nuestros tabuladores y tener un resultado más óptimo.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--<input type="hidden" class="form-control" name="plan3" id="plan3" value="PLAN DE ASESORIA NUTRICIONAL PLAN 3 $1,600 / 3 MESES" required>-->
                    <input type="hidden" class="form-control" name="plan3" id="plan3" value="PLAN DE ASESORIA NUTRICIONAL PLAN 3 $1,800 / 3 MESES" required>
                    <p style="font-family: Copperplate">Sus datos personales, serán utilizados para ajustar su peso y estura a nuestros tabuladores y tener un resultado más óptimo.</p>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/bega/nutricional.js');?>"></script>
</body>
</html>